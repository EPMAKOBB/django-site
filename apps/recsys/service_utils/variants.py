...
from .grading import _trim_trailing_blank_rows, grade_answer
...
def _grade_answer(
    ...
    *,
    ...
    if scoring_scheme == TaskType.ScoringScheme.EGE_PAIRS_2027:
        return grade_answer(scoring_scheme, correct_answer, response_value, max_score=max_score)
